      ...
      <section className="relative flex min-h-[85vh] items-center justify-center overflow-hidden pt-32 pb-20 px-6 sm:px-10">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/store"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-3 rounded-full bg-primary px-8 py-4 text-xs font-bold uppercase tracking-widest text-black shadow-[0_0_30px_rgba(249,115,22,0.4)] hover:scale-105 transition-all"
            >
            ...
            <Link
              href="/community"
              className="inline-flex w-full sm:w-auto items-center justify-center gap-3 rounded-full border border-white/20 bg-zinc-900/80 px-8 py-4 text-xs font-bold uppercase tracking-widest text-white backdrop-blur-md hover:border-primary hover:text-primary transition-all"
            >
