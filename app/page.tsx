...
export default function CommunityPage() {
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-primary selection:text-black">
      ...
      <section className="relative overflow-hidden border-b border-white/10 pt-28 pb-20 lg:pt-32 lg:pb-24">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[450px] w-[700px] rounded-full bg-primary/15 blur-[160px] pointer-events-none" />
        </div>

        {/* Hero İçerik (Daha Geniş ve Ferah Konteyner) */}
        <div className="relative z-10 mx-auto max-w-7xl px-6 text-center sm:px-8 lg:px-12">
          ...
          {/* Açıklama Metni */}
          <p className="mx-auto mt-6 max-w-3xl text-base font-normal leading-relaxed text-zinc-300 sm:text-lg">
          ...
          {/* 2'li İstatistik Şeridi */}
          <div className="mx-auto mt-10 grid max-w-lg grid-cols-2 gap-4 pt-6 border-t border-white/10">
            {STATS.map((stat, idx) => {
              const Icon = stat.icon
              return (
                <div
                  key={idx}
                  className="flex flex-col items-center justify-center rounded-2xl border border-white/5 bg-zinc-950/60 p-4 backdrop-blur-md transition-all hover:border-primary/30"
                >
                  <div className="flex items-center gap-2 text-primary">
                    <Icon className="h-4 w-4" />
                    <span className="text-2xl font-black tracking-tight text-white">{stat.value}</span>
                  </div>
                  <span className="mt-1 text-[11px] font-medium uppercase tracking-wider text-zinc-400">
                    {stat.label}
                  </span>
                </div>
              )
        ...
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
          <div className="mb-10 flex flex-col items-center text-center">
            ...
            <p className="mt-3 max-w-xl text-sm leading-relaxed text-zinc-400 sm:text-base">
              Branşını seç, detayları incele ve takvimine ekle.
            </p>
          </div>
