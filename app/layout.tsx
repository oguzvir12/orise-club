    ...
    >
      <body className="font-sans antialiased bg-[#111111] text-[#F5F2EC] flex flex-col min-h-screen selection:bg-[#F74A05] selection:text-white overflow-x-hidden">
        <CartProvider>
          ...
          {/* SAĞ ALT: İstediğin gibi sağ altta sadece 2 ince çizgi/ikon şeklinde duran, üzerine tıklanınca açılan şık WhatsApp butonu */}
          <div className="fixed bottom-6 right-6 z-[90]">
            {isWhatsappExpanded ? (
              ...
              <button 
                ...
                className="flex h-11 w-11 items-center justify-center rounded-full bg-black/60 border border-[#D8D6D2]/20 text-[#25D366] shadow-2xl backdrop-blur-md hover:scale-110 transition-transform cursor-pointer"
                title="Destek Hattı"
              >
                {/* İstediğin gibi iki ince çizgi / minimal ikon görünümü */}
                <div className="flex flex-col gap-1 items-center justify-center w-5">
                  <div className="w-4 h-[2px] bg-[#25D366] rounded-full"></div>
                  <div className="w-2.5 h-[2px] bg-[#25D366] rounded-full"></div>
                </div>
              </button>
            )}
          </div>
